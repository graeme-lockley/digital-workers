...
5. [S01-05-release-dry-run-placeholder.md](../../stories/done/S01-05-release-dry-run-placeholder.md) - Add a non-publishing release workflow placeholder that runs in dry-run mode.
